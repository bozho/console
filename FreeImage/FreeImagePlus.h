...
public:
	...
	*/
	...
	/** @brief Returns a pointer to the start of the given scanline in the bitmap痴 data-bits.
	...
	*/
	...
	/**
	8-bit transparency : get the bitmap痴 transparency table.
	@return Returns a pointer to the bitmap痴 transparency table.
	@see FreeImage_GetTransparencyTable
	*/
	BYTE* getTransparencyTable() const;

	/** 
	8-bit transparency : set the bitmap痴 transparency table.
